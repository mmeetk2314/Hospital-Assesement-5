...
namespace Hospital_Assesement_5.Controllers
{
    public class HospitalsController : Controller
    {
        ...
        public HospitalsController(Hospital_Assesement_5Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("HospitalID,HospitalName,HospitalBranch,HospitalOpeningDate,HospitalAddress,HospitalFloor")] Hospital hospital)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HospitalID,HospitalName,HospitalBranch,HospitalOpeningDate,HospitalAddress,HospitalFloor")] Hospital hospital)
        {
